...
export const Certifications = memo(() => {
  ...
  return (
    <section id="certifications" className="border-t border-[var(--border-primary)]" aria-label="Credentials Section">
      <div className="section-layout">
        <m.div
          ...
          className="card-glass p-6 md:p-8 flex flex-col md:flex-row md:items-center justify-between gap-4 md:gap-8"
        >
          <div className="space-y-1">
            <span className="section-label">Verified Accreditation</span>
